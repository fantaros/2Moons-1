<header>
	...
	<nav>
		...
		<li><a href="?lang={$langKey}" rel="alternate" hreflang="{$langKey}" title="{$langName}" class="flags"><img src="resource/images/flags/{$langKey}.png" title="{$langName}" alt="{$langName}"></a></li>
		{/foreach}
		</ul>
		{/if}
	</nav>
