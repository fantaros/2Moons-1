...
{else}
<tr>
	<td><a href="#" onclick="return Dialog.info({$elementID})"><img src="{$themePath}gebaeude/{$elementID}.{if $elementID >=600 && $elementID <= 699}jpg{else}gif{/if}" width="50" height="50"></a></td>
