...
<input type="hidden" name="mode" value="send">
	...
	<tbody>
		...
		<tr>
			<td colspan="3"><img src="banner.php?id={$userID}" alt="" width="590" height="95" id="userpic"><br><br><table><tr><td class="transparent">HTML:</td><td class="transparent"><input type="text" value='<a href="{$smarty.const.PROTOCOL}{$smarty.const.HTTP_HOST}{$smarty.const.HTTP_ROOT}{if $ref_active}index.php?ref={$userid}{/if}"><img src="{$smarty.const.PROTOCOL}{$smarty.const.HTTP_HOST}{$smarty.const.HTTP_ROOT}banner.php?id={$userid}"></a>' readonly="readonly" style="width:450px;"></td></tr><tr><td class="transparent">BBCode:</td><td class="transparent"><input type="text" value="[url={$smarty.const.PROTOCOL}{$smarty.const.HTTP_HOST}{$smarty.const.HTTP_ROOT}{if $ref_active}index.php?ref={$userid}{/if}][img]{$smarty.const.PROTOCOL}{$smarty.const.HTTP_HOST}{$smarty.const.HTTP_ROOT}banner.php?id={$userid}[/img][/url]" readonly="readonly" style="width:450px;"></td></tr></table></td>
		</tr>
		{/if}
		<tr>
