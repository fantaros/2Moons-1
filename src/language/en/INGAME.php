...
$LNG['op_email_address']						= 'Email address';
$LNG['op_permanent_email_address']			= 'Permanent email address';
...
$LNG['op_email_address_descrip']				= 'You can change this e-mail address at any time. Will become the permanent e-mail after 7 days, without changes.';
...
$LNG['bs_derbis_report']   					= "Needed for recycling the debris: %s %s or %s %s. ";
$LNG['bs_steal_report']   					= "Needed to capture the resources: %s %s or %s %s or %s %s.";
