...
$LNG['PM']									= '[PM]';
$LNG['write_message']						= 'Scrivi messaggio';
$LNG['ready']								= 'Pronto';
...
//----------------------------------------------------------------------------//
// Topnav
$LNG['tn_vacation_mode']					= "Adesso sei in modalit&agrave; vacanza";
$LNG['tn_delete_mode']						= 'L\'account %s verr&agrave; automaticamente cancellato!';

//----------------------------------------------------------------------------//
// Menu
$LNG['lm_overview']							= 'Panoramica';
...
$LNG['lm_fleettrader']						= 'Mercante di navi';
...
//----------------------------------------------------------------------------//
// Overview
$LNG['ov_newname_specialchar']				= 'Il nome del pianeta pu&ograve; essere formato solo da numeri, lettere, spazi, _,-,.';
$LNG['ov_newname_done']						= 'Nome del pianeta aggiornato!';
$LNG['ov_planet_abandoned']					= 'Il pianeta &egrave; stato abbandonato!';
$LNG['ov_principal_planet_cant_abanone']	= 'Non puoi cancellare il pianeta principale!';
$LNG['ov_abandon_planet_not_possible']		= 'Il pianeta non pu&ograve; essere cancellato, poich&egrave; ci sono azione in sospeso!';
...
$LNG['ov_max_developed_fields']				= 'Massimo dei campi permessi';
$LNG['ov_fleet']							= 'Flotte';
$LNG['ov_admins_online']					= 'Admins Attivi';
$LNG['ov_no_admins_online']					= 'Attualmente, non ci sono amministratori online';
...
$LNG['ov_noreflink']						= 'Al momento non hai ancora reclutato nessun utente.';
...
$LNG['fl_shortcut_save']					= 'Salva Shortcut';
$LNG['fl_shortcut_saved']					= 'Shortcut salvato!';
...
$LNG['fl_already_invited']					= ' &egrave; gi&agrave; stato invitato.';
...
$LNG['fl_no_expedition_slot']				= 'Puoi far partire pi&ugrave; spedizioni!';
$LNG['fl_invalid_mission']					= 'Missione invalida';
$LNG['fl_bash_protection']					= 'Regola del Bash';
$LNG['fl_admin_attack']						= 'Puoi attaccare gli amministratori';
$LNG['fl_target_exists']					= 'Pianeta obbiettivo';
$LNG['fl_target_not_exists']				= 'Il pianeta obbiettivo non esiste!';
...
$LNG['fl_not_enough_space']					= 'Non hai abbastanza spazio nel cargo disponibile.';
...
$LNG['bd_build_defenses']					= 'Costruzioni';
...
$LNG['sys_notenough_money'] 				= 'Non hai abbastanza risorse su %s <a href="./game.php?page=buildings&amp;cp=%d&amp;re=0">[%d:%d:%d]</a> per costruire che vuoi. <br>Le tue risorse sono %s %s , %s %s e %s %s. <br>Il costo della costruzione &egrave; di %s %s , %s %s and %s %s.';
...
//----------------------------------------------------------------------------//
// Info
$LNG['in_jump_gate_done']					= 'Lo StarGate &egrave; stato usato, il prossimo salto potr&agrave; essere fatto tra:';
$LNG['in_jump_gate_error_data']				= 'Errore, dati per il salto incorretti!';
$LNG['in_jump_gate_not_ready_target']		= 'Lo StarGate non &egrave; pronto sulla luna finale, lo sar&agrave; in ';
...
$LNG['in_capacity']    						= 'Capacit&agrave; deicargo';
...
$LNG['in_jump_gate_no_target']				= 'Nessun jump gate disponibile.';
...
$LNG['al_request_last_onlinetime']          = 'Letzte AktivitÃƒÂ¤t';
...
$LNG['al_diplo_level.3']                   = 'Accordo commerciale';
...
$LNG['al_diplo_no_alliance']				= 'Non vi &egrave; alcuna alleanza con il nome di %s!';
$LNG['al_diplo_exists']						= 'Esiste gi&agrave; un rapporto di diplomazia valido o non ancora accettato diplomatica con l\'alleanza "%s"!';
...
$LNG['bu_new_request_body']					= 'Hello %s,<br>%s ti ha mandato una richiesta di amicizia!';
...
$LNG['op_username_changed']					= 'Usarname cambiato';
...
$LNG['op_end_vacation_mode']				= 'Modalità vacanza terminata.';
...
$LNG['op_email_address']						= 'Indirizzo e-mail';
$LNG['op_permanent_email_address']			= 'Indirizzo e-mail permanente';
...
$LNG['op_email_address_descrip']				= 'Puoi cambiare indirizzo e-mail temporaneo. La nuova e-mail diventerà l\'email permanente dopo 7 giorni se non sono stati effettuati cambiamenti';
...
$LNG['css_account_banned_expire']           = 'Il tuo account &egrave; gi&agrave; sbannato %s!';
$LNG['css_goto_homeside']                   = '<a href="./index.php">Vai all\'homepage</a>';
$LNG['css_server_maintrace']                = 'Manutenzione del server<br><br>Il gioco &egrave; chiuso.<br><br>Até: %s';

//----------------------------------------------------------------------------//
// Attivazione della flotta
...
$LNG['sys_refferal_text']        	 		= 'Il giocatore %s &egrave; stato reclutato da voi ha raggiunto %s punti.<br><br>Se tu inviti un giocatore attivo, guadagnerai %s %s';
...
$LNG['fa_vacation_mode']					= 'Il giocatore &egrave; in modalit&agrave vacanza';
$LNG['fa_week_player']						= 'Il giocatore &egrave; troppo debole';
$LNG['fa_strong_player']					= 'Il giocatore &egrave; troppo forte';
...
$LNG['fa_vacation_mode_current']			= 'Errore, sei in modalit&agrave; vacanza!';
...
$LNG['ti_msgtime']							= 'Messaggio scritto il';
//----------------------------------------------------------------------------//
// Record
...
//----------------------------------------------------------------------------//
// Simulatore di Battagglia

$LNG['bs_derbis_report']   					= "Necessario per il riciclaggio dei detriti: %s %s o %s %s. ";
$LNG['bs_steal_report']   					= "Necessario per catturare le risorse: %s %s o %s %s o %s %s.";
$LNG['bs_names']   							= "Nome";
...
$LNG['lo_redirect']							= 'Rindirizzamento';
$LNG['lo_notify']							= 'Sarai rindirizzato tra <span id="seconds">5</span> secondi';
