...
$LNG['op_email_address']						= 'Endereço de E-Mail';
$LNG['op_permanent_email_address']			= 'Endereço de E-Mail permanente';
...
$LNG['op_email_address_descrip']				= 'Podes alterar este endereço de email, em qualquer altura. Tornar-se-á o email permanente após 7 dias, sem alterações.';
...
$LNG['bs_derbis_report']	                = "Precisas de %s %s ou %s %s para recolheres o campo de destroços.";
$LNG['bs_steal_report']	                    = "Precisas de %s %s ou %s %s ou %s %s para os recursos que se encontram no planeta.";
$LNG['bs_names']		                    = "Frota";
