 ...
 * @info $Id: CustomAJAXChat.php 2801 2013-10-05 23:55:41Z slaver7 $
 * @link http://2moons.cc/
 */
...
class CustomAJAXChat extends AJAXChat
{
	...
	function setSessionVar($key, $value, $prefix=null) {
		...
		if(isset(Session::get()->chat))
		{
			$sessionData	= array_merge(Session::get()->chat, array($prefix.$key => $value));
		}
		else
		{
		...
		Session::get()->__set('chat', $sessionData);
	}
	...
	function revalidateUserID() {
		if($this->getUserID() === Session::get()->userId) {
			return true;
		}
