 ...
 * @info $Id: ShowCreatorPage.php 2803 2013-10-06 22:23:27Z slaver7 $
 * @link http://2moons.cc/
 */
...
function ShowCreatorPage()
{
	...
	switch ($_GET['mode'])
	{
		...
		case 'planet':
			...
			$template->show('CreatePagePlanet');
		break;
		default:
			$template->assign_vars(array(	
