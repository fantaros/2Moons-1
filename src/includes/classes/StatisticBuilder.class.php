 ...
 * @info $Id: StatisticBuilder.class.php 2800 2013-10-04 22:07:04Z slaver7 $
 * @link http://2moons.cc/
 */
...
class StatisticBuilder
{
	...
	private function GetUsersInfosFromDB()
	{
		...
		$fleetResult    = $db->select('SELECT %%FLEETS_ELEMENTS%%.*,fleet_owner FROM %%FLEETS_ELEMENTS%% INNER JOIN %%FLEETS%% USING(fleetId);');
